...
//        cPane.add(jbnExit, gridBagConstraintsx16);
     ...
     public void savePerson(){  
	   	...
	   	try{
	   		...
	   		System.out.print("Input contains string");
   ...
   System.out.println("Saved = "+pDAO.getpersonsList().size());
     }
   ...
   public void displayNextRecord(){
	...
	//  personsList during search     
   	...
   	if(recordNumber >= pDAO.getpersonsList().size()){
       ...
       recordNumber -- ; 
   		...
   		jbnBack.setEnabled(true);
   		PersonInfo person = (PersonInfo) pDAO.getpersonsList().get(recordNumber);
