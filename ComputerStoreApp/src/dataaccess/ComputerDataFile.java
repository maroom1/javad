...
public class ComputerDataFile implements ComputerReader, ComputerWriter, ComputerConstants
{
    ...
    public Computer getComputer(String code)
    {
        for (Computer c : computers)
        {
            if (c.getPartnumber().equals(code))
                return c;
        }
        return null;
    }
